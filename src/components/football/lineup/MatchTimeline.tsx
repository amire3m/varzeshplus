    ...
    <div className="space-y-5">
      ...
      <section className="panel p-4 md:p-5">
        <div className="flex items-center justify-center gap-4 flex-wrap">
          ...
          <div className="flex flex-col items-center px-2">
            ...
            {isPenaltyDecision && (
              <span className="text-xs mt-1 px-2.5 py-0.5 rounded-full" style={{ background: "rgba(74,225,131,0.12)", color: "#4AE183" }}>
      ...
      {tl.hasPenaltyShootout && (
        <section className="glass-panel p-4">
          <h3 className="headline text-base mb-3 flex items-center gap-2"><span className="material-symbols-outlined text-[18px]" style={{ color: "#4AE183" }}>sports_soccer</span> ضربات پنالتی</h3>
