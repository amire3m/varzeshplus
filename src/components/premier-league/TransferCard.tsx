  ...
  return (
    <div className={`glass-panel p-4 flex flex-wrap items-center gap-3 border-r-[3px] ${transfer.official ? "" : "border-dashed"}`} style={{ borderRightColor: transfer.official ? "var(--color-club-green)" : "#f9c759" }}>
      ...
      <div className="flex items-center gap-2 text-xs ml-auto">
        <span className={`px-2 py-1 rounded-full font-bold tabular ${transfer.official ? "" : ""}`} style={{ background: transfer.official ? "rgba(74,225,131,0.12)" : "rgba(249,199,89,0.12)", color: transfer.official ? "#4AE183" : "#f9c759" }}>{TYPE_LABEL[transfer.type]}</span>
