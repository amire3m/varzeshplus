...
export const SPORTS: Sport[] = [
  { key: "football", name: "فوتبال", emoji: "⚽", icon: "sports_soccer", color: "#4AE183", subs: ["بوندسلیگا", "پریمیرلیگ", "لیگ خلیج فارس", "سری آ", "لالیگا"] },
  ...
  { key: "swimming", name: "شنا", emoji: "🏊", icon: "pool", color: "#FFD34D", subs: ["قهرمانی جهان", "المپیک", "لیگ ایران"] },
